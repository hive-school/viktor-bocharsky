...
use BU\ProjectBundle\Form\StatusType;

/**
 * Status controller.
 *
 * @Route("/project-manager/status")
 */
class StatusController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BUProjectBundle:Status')->findAll();
     ...
     * @Method("POST")
     * @Template("BUProjectBundle:Status:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('BUProjectBundle:Status')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("BUProjectBundle:Status:edit.html.twig")
     */
